    ...
    for (var d3 = 0; d3 <= 9; d3++) {
      for (var d4 = 0; d4 <= 9 ;d4++){
          for(var d5 = 0; d5 <= 9; d5++){
              for(var d6 = 0; d6 <= 9; d6++){
                  for(var d7 = 0; d7 <= 9; d7++){
                      if (d7!=0 && Math.abs(8900000*d1 + 890000*d2 + 89000*d3 + 8900*d4 + 890*d5 + 89*d6 - 999991*d7) < 10){
                          console.log({d1},{d2},{d3},{d4},{d5},{d6},{d7})
                  }
              } 
          }
      ...
      for (var d4 = 0; d4 <= 9 ;d4++){
          for(var d5 = 0; d5 <= 9; d5++){
              for(var d6 = 0; d6 <= 9; d6++){
                  for(var d7 = 0; d7 <= 9; d7++){
                      for(var d8 = 0; d8 <= 9; d8++){
                          if (d1 != 0 &&d8!=0&&Math.abs(89000000*d1 + 8900000*d2 + 890000*d3 + 89000*d4 + 8900*d5 + 890*d6 + 89*d7 - 9999991*d8 )< 10){
                            console.log({d1},{d2},{d3},{d4},{d5},{d6},{d7},{d8})
                      }
                  }
              } 
          ...
          for(var d5 = 0; d5 <= 9; d5++){
              for(var d6 = 0; d6 <= 9; d6++){
                  for(var d7 = 0; d7 <= 9; d7++){
                      for(var d8 = 0; d8 <= 9; d8++){
                          for(var d9 = 0; d9 <= 9; d9++){
                              if (d9!= 0 && Math.abs(890000000*d1 + 89000000*d2 + 8900000*d3 + 890000*d4 + 89000*d5 + 8900*d6 + 890*d7 + 89*d8 - 99999991*d9) < 10){
                                  console.log({d1},{d2},{d3},{d4},{d5},{d6},{d7},{d8},{d9})
                          }
                      }
                  }
